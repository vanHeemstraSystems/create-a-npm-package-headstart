...
For *husky* users, we we are, add the following configuration to the project's package.json file:
...
Add the "Commitizen friendly" badge to your README.md file using the following markdown:
